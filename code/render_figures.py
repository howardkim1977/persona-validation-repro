...
def fig1():
    act=[13.7,89.2,93.2,69.6,60.7,92.2,5.6,22.7]; gem=[39.9,64.5,100.0,29.6,48.0,97.6,2.0,38.8]; exa=[37.1,83.7,96.7,57.1,74.4,69.4,13.6,44.1]
...
def fig3():
    ...
    gem=[39.9,64.5,100.0,29.6,48.0,97.6,2.0,38.8]; exa=[37.1,83.7,96.7,57.1,74.4,69.4,13.6,44.1]
