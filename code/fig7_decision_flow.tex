...
\node[dec, below=of d1] (du) {Segment entirely unobserved \emph{and} calibration beats a real-only regression on held-out cells?};
...
\draw[arr] (du.west) -- ++(-6mm,0) |- node[pos=0.25,left]{yes} (o4.west);
