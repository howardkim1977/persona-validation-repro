...
updated 2026-07-12. Registration type: Secondary Data Preregistration. The
...
| H1 agreement measured against a chance/null reference | Secs. IV-H, Table 6 | Deviation — see C |
...
|---|---|---|
| **RQ3 (calibration) in its entirety** — the registration states only RQ1 and RQ2; no calibration research question, hypothesis, or analysis plan was registered | Secs. III-F, IV-G; Tables 4–5 | Added after the raw comparison showed large, structured (not random) error, to test whether that structure is correctable |
